...
/**
 * Created by yuanren123 on 2017/9/13.
 */
...
public class CollectDetailActivity extends BaseActivity {
      ...
      @ViewInject(R.id.iv_collect_voice)
      private ImageView iv_voice;
      @ViewInject(R.id.gv_collect_voice)
      private MyGifView gv_voice;
      @ViewInject(R.id.iv_collect_voice1)
      private ImageView iv_voice1;
      @ViewInject(R.id.gv_collect_voice1)
      ...
      protected void onCreate(Bundle savedInstanceState) {
            ...
            iv_like.setOnClickListener(new View.OnClickListener() {
                  ...
                  public void onClick(View view) {
                        ...
                        iv_like.setVisibility(View.GONE);
                        iv_ont_like.setVisibility(View.VISIBLE);
                        Toast.makeText(CollectDetailActivity.this, "取消收藏", Toast.LENGTH_SHORT).show();
                  }
            });
            ...
            iv_ont_like.setOnClickListener(new View.OnClickListener() {
                  ...
                  public void onClick(View view) {
                        ...
                        iv_like.setVisibility(View.VISIBLE);
                        iv_ont_like.setVisibility(View.GONE);
                        Toast.makeText(CollectDetailActivity.this, "收藏成功", Toast.LENGTH_SHORT).show();
            ...
            rl_continue.setOnClickListener(new View.OnClickListener() {
                  @Override
                  public void onClick(View view) {
                        Intent intent = new Intent(CollectDetailActivity.this,CollectActivity.class);
